...
## Lab Objectives
- Build a Windows Active Directory environment in Oracle VirtualBox
...
|---|---|---|
| Windows Server VM | Domain Controller | `192.168.10.10` |
| Windows Client VM | Domain-Joined Client | `192.168.10.11` |

The client machine was configured to use the Domain Controller (`192.168.10.10`) as its preferred DNS server to support Active Directory authentication and name resolution.
...
## What I Learned
This lab reinforced how Active Directory is used to structure users and manage access in a Windows domain environment. It also demonstrated the importance of combining organizational structure with group-based permissions to implement clean and scalable access control.

I also gained hands-on experience with:
- bulk user creation through PowerShell
- organizing users into department-based OUs
- using security groups instead of assigning permissions user by user
- configuring both share permissions and NTFS permissions correctly
- validating both successful and denied access scenarios
...
This project gave me hands-on practice with how identity and access management is handled in a Windows domain, and helped me better understand how administrators use Active Directory to organize users and enforce least-privilege access.
